...
const Works1Slider = () => {
  ...
  return (
    <section className="work-carousel section-padding pt-0 metro position-re mt-50 mb-50">
      <div className="container ontop">
      <h2 className="extra-title mb-30 text-center">Create and manage listings easily.</h2>
        <div className="row">
