...
const ProjectDetails2Header = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url(/img/portfolio/project2/Nicolinehus.webp)", backgroundPosition: "center" }}
      data-overlay-dark="4"
    >
        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="item mt-30">
              <h6>Client</h6>
              <p>
                <a href="https://formuepleje.dk/">FormuePleje</a>
              </p>
            </div>
          </div>
          <div className="col-lg-3">
